...
library(readr)
library(here)
titanic_train <- read_csv(here("Documents", "R", "Workshop", "PredictiveModeling", "data","titanic_train.csv"))
titanic_test <- read_csv(here("Documents", "R", "Workshop", "PredictiveModeling", "data","titanic_test.csv"))
```
